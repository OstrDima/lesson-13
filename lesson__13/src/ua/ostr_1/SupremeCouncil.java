...
public final class SupremeCouncil {
	...
	public void addDeputyGroup() {
		...
		System.out.println(deputyGroup.toString() + " успішно додана до Верховної Ради!");
	}
		...
		if (typeCorrect) {
			...
			while (iterator.hasNext()) {
				...
				if (nextDeputyGroup.getDeputyGroupName().equalsIgnoreCase(deputyGroupName)) {
					iterator.remove();
					System.out.println(nextDeputyGroup.toString() + " успішно видалено з Верховної Ради!");
				}
			}

		} else {
			System.out.println("Введеної фракції у Верховній Раді немає!");
		}
	}
